...
export const ProjectsInfo = [
    {
        ...
        description:
            "A scalable e-commerce platform built with microservices architecture. It includes user authentication, product management, and order processing.",
        image: { PicProject1 },
        technologies: [
            "Spring Boot",
            "Spring Cloud",
    ...
    },
    {
        ...
        description:
            "A full-stack clothing store application with user authentication, product management, and order processing. Built with Spring Boot and Thymeleaf.",
        image: { PicProject2 },
        technologies: [
            "Spring Boot",
            "Spring Security",
